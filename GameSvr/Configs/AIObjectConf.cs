...
namespace GameSvr
{
    public class AIObjectConf : IniFile
    {
        ...
        public void LoadConfig(RobotPlayObject playObject)
        {
            ...
            playObject.m_UseItemNames[Grobal2.U_DRESS] = ReadString("UseItems", "UseItems0", "布衣(男)"); 
            playObject.m_UseItemNames[Grobal2.U_WEAPON] = ReadString("UseItems", "UseItems1", "木剑"); 
            playObject.m_UseItemNames[Grobal2.U_RIGHTHAND] = ReadString("UseItems", "UseItems2", ""); 
            playObject.m_UseItemNames[Grobal2.U_NECKLACE] = ReadString("UseItems", "UseItems3", ""); 
            playObject.m_UseItemNames[Grobal2.U_HELMET] = ReadString("UseItems", "UseItems4", ""); 
            playObject.m_UseItemNames[Grobal2.U_ARMRINGL] = ReadString("UseItems", "UseItems5", ""); 
            playObject.m_UseItemNames[Grobal2.U_ARMRINGR] = ReadString("UseItems", "UseItems6", ""); 
            playObject.m_UseItemNames[Grobal2.U_RINGL] = ReadString("UseItems", "UseItems7", ""); 
            playObject.m_UseItemNames[Grobal2.U_RINGR] = ReadString("UseItems", "UseItems8", ""); 
